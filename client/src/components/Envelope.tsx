        ...
        >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="w-full flex justify-end pr-4 md:pr-8">
                  <p className="font-script text-xl md:text-2xl text-[#8B0000]">
                    LOVE, MEANIE
                  </p>
                </div>
              </div>
          ...
          <div className="absolute inset-0 bg-[#E8E0D5] rounded-b-lg shadow-xl z-0 overflow-hidden border border-[#D6CBB8]">
             ...
             <div className="absolute bottom-4 left-0 right-0 text-center opacity-60">
                <p className="text-[10px] tracking-[0.2em] font-serif uppercase text-[#2b1500] font-medium pt-[22px] pb-[22px]">COME HOME BABY</p>
             </div>
          </div>
